...
const productCatalog = [
  {
    ...
    logoText: "EMS",
    description:
      "A streamlined internal platform for attendance, employee records, workflow management and day-to-day operations.",
    accent: "from-cyan",
    icon: Users,
  ...
  },
  {
    ...
    logoText: "PNB",
    description:
      "A simple booking platform that helps customers check availability, choose services and confirm reservations with ease.",
    accent: "from-orange",
    icon: CalendarCheck2,
  ...
  },
  {
    ...
    logoText: "AI",
    description:
      "An AI-powered platform for generating blogs, marketing copies, captions and content drafts for digital teams.",
    accent: "from-cyan",
    icon: Brain,
  ...
  },
  {
    ...
    logoText: "IMS",
    description:
      "A centralized inventory platform for stock visibility, warehouse movement, reorder planning and day-to-day inventory operations.",
    accent: "from-indigo",
    icon: Layers3,
  ...
  },
  {
    ...
    logoText: "POS",
    description:
      "An upcoming point-of-sale solution for billing, product look-up, sales tracking and day-to-day retail operations.",
    accent: "from-orange",
    icon: CreditCard,
...
const deliveryPoints = [
  {
    ...
    text: "Products help teams reduce repeated work and manage daily tasks more clearly.",
  },
  {
    icon: MonitorCog,
    title: "Ready For Customization",
    text: "Modules and screens can be adjusted to match your business process.",
  },
  {
    icon: Clock3,
    title: "Faster Product Rollout",
    text: "Ready product foundations help your team launch faster with less setup time.",
  },
];
    ...
    <div className="products-page">
      <section className="products-hero">
        ...
        <div className="products-hero-content">
          <div className="products-hero-copy products-reveal">
            <h1>Business products for modern teams.</h1>
            <p>
              Explore Pirnav product offerings built to support operations,
              collaboration, and modern business deliveries.
            </p>
      ...
      <section id="product-screens" className="products-screens-section">
        <div className="products-screens-header products-reveal">
          ...
          <p>
            View sample screens from each product.
          </p>
        </div>
      ...
      <section id="product-fit" className="products-fit-section">
        <div className="products-fit-copy products-reveal">
          ...
          <h2>Built to fit your business.</h2>
          <p>
            Choose the product you need and shape it around your workflow.
          </p>
        </div>
            ...
            return (
              <article
                ...
                className={`products-fit-card products-reveal ${
                  item.title === "Faster Product Rollout" ? "products-fit-card-rollout" : ""
                }`}
                style={{ transitionDelay: `${index * 0.08}s` }}
              >
                ...
                <h3>
                  {item.title === "Faster Product Rollout" ? (
                    <>
                      Faster Product
                      <br />
                      Rollout
