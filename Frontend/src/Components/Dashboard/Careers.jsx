...
const cultureCards = [
  {
    ...
    text: "Contribute to products and services that solve real business needs.",
  },
  {
    title: "Open teamwork",
    text: "Work with teams that communicate clearly and support shared progress.",
  },
  {
    title: "Steady growth",
    text: "Learn through practical work, useful feedback and new opportunities.",
  },
];
    ...
    <div className="careers-page">
      <section className="careers-hero">
        ...
        <div className="careers-hero-content">
          <div className="careers-copy">
            ...
            <p>
              Join a team that values clear goals, steady growth and meaningful work.
            </p>
      ...
      <section className="culture-section">
        <div className="section-heading">
          ...
          <h2>Work with clarity and support.</h2>
          <p>
            We create a simple work culture where people can learn, contribute and grow with confidence.
          </p>
        </div>
