...
const operatingModel = [
  ...
  },
  {
    ...
    title: "Deliver",
    text: "We build in simple steps with clear progress and regular feedbacks.",
  },
  {
    step: "04",
    icon: FaServer,
    ...
    <div className="about-page">
        ...
        <div className="about-hero-overlay">
          <div className="about-hero-copy fade-up">
            ...
            <p className="about-hero-text">
              Pirnav Software Solutions helps business build, launch and
      ...
      <section className="about-intro-panel fade-up">
        <div className="about-intro-main">
          ...
          <h2>Simple IT support for business that want steady growth.</h2>
          <p>
        ...
        <div className="about-intro-side">
          <div className="about-mini-note">
            ...
            <span>Pirnav team focusing on practical business technology support</span>
          </div>
          <div className="about-mini-note">
        ...
        <div className="about-feature-grid">
          <article className="about-feature-card fade-up">
            ...
            <div className="about-feature-copy">
              ...
              <p>
                Good planning works best when it connects with timelines and real work.
              </p>
            </div>
          </article>
          ...
          <article className="about-feature-card fade-up">
            ...
            <div className="about-feature-copy">
              ...
              <p>
                We turn findings into practical choices that support goals, timelines and delivery.
              </p>
            </div>
          </article>
          ...
          <article className="about-feature-card fade-up">
            ...
            <div className="about-feature-copy">
              ...
              <h3>Our team brings development, testing, staffing and support together.</h3>
              <p>
                This helps the work stay clear and smooth from scratch to finish.
              </p>
            </div>
          </article>
        </div>
      ...
      <section className="about-cta-section fade-up">
        <div className="about-cta-shell">
          <div>
            ...
            <h2>Build better with Pirnav.</h2>
            <p>
